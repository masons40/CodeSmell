...
document.querySelector('.up-arrow').scrollIntoView({ 
  behavior: 'smooth' 
    ...
    var checked_box="java";
    
    $("#java").click(function(){
        $(this).attr("checked");
        $("#java-checkmark").css("background-color","#006db8");
        $("#zip").removeAttr("checked");
        $("#zip-checkmark").css("background-color","#eee");
        checked_box="java";
    ...
    $("#zip").click(function(){
        $(this).attr("checked");
        $("#zip-checkmark").css("background-color","#ef226f");
        $("#java").removeAttr("checked");
        $("#java-checkmark").css("background-color","#eee");
        checked_box="zip";
        console.log(checked_box);
    });
